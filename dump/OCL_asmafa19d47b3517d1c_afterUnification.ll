; ------------------------------------------------
; OCL_asmafa19d47b3517d1c_afterUnification.ll
; ------------------------------------------------
...
define spir_kernel void @_ZTSZZ4mainENKUlRT_E_clIN4sycl3_V17handlerEEEDaS0_EUlNS4_7nd_itemILi3EEEE_(float addrspace(3)* %0, float addrspace(1)* %1, float addrspace(1)* %2, <8 x i32> %r0, <8 x i32> %payloadHeader, i16 %localIdX, i16 %localIdY, i16 %localIdZ, i32 %bufferOffset, i32 %bufferOffset1) #0 {
  ...
  %9 = bitcast [0 x i8] addrspace(3)* @_ZTSZZ4mainENKUlRT_E_clIN4sycl3_V17handlerEEEDaS0_EUlNS4_7nd_itemILi3EEEE_-ExtSLM to float addrspace(3)*
  %10 = getelementptr inbounds float, float addrspace(3)* %9, i64 %5
  %11 = bitcast float addrspace(3)* %10 to i32 addrspace(3)*
  store i32 %8, i32 addrspace(3)* %11, align 4
  call void @llvm.genx.GenISA.memoryfence(i1 true, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false)
  call void @llvm.genx.GenISA.threadgroupbarrier()
  %12 = icmp ult i16 %localIdX, 64
  br i1 %12, label %13, label %18

13:                                               ; preds = %3
  %14 = bitcast float addrspace(3)* %10 to i32 addrspace(3)*
  %15 = load i32, i32 addrspace(3)* %14, align 4
  %16 = getelementptr inbounds float, float addrspace(1)* %2, i64 %5
  %17 = bitcast float addrspace(1)* %16 to i32 addrspace(1)*
  store i32 %15, i32 addrspace(1)* %17, align 4
  br label %18
