; ------------------------------------------------
; OCL_asmafa19d47b3517d1c_push_analysis.ll
; ------------------------------------------------
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32-p131072:32:32:32-p131073:32:32:32"
...
define spir_kernel void @_ZTSZZ4mainENKUlRT_E_clIN4sycl3_V17handlerEEEDaS0_EUlNS4_7nd_itemILi3EEEE_(float addrspace(3)* nocapture readnone %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture %2, <8 x i32> %r0, <8 x i32> %payloadHeader, i16 %localIdX, i16 %localIdY, i16 %localIdZ, i32 %bufferOffset, i32 %bufferOffset1) #0 {
  ...
  %8 = inttoptr i32 %7 to i32 addrspace(131072)*
  %9 = load i32, i32 addrspace(131072)* %8, align 8
  %conv.i.i.tr = zext i16 %localIdX to i32
  %10 = shl nuw nsw i32 %conv.i.i.tr, 3
  %11 = and i32 %10, 2040
  %12 = inttoptr i32 %11 to i32 addrspace(3)*
  store i32 %9, i32 addrspace(3)* %12, align 8
  call void @llvm.genx.GenISA.memoryfence(i1 true, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false)
  call void @llvm.genx.GenISA.threadgroupbarrier()
  %13 = icmp ult i16 %localIdX, 64
...
14:                                               ; preds = %3
  %15 = load i32, i32 addrspace(3)* %12, align 8
  %16 = inttoptr i32 %7 to i32 addrspace(131073)*
  store i32 %15, i32 addrspace(131073)* %16, align 8
  br label %17
...
!IGCMetadata = !{!0}
!igc.functions = !{!277}
!opencl.ocl.version = !{!291, !291, !291, !291, !291}
!opencl.spir.version = !{!291, !291, !291, !291, !291}
!llvm.ident = !{!292, !292, !292, !292, !292}
!llvm.module.flags = !{!293}

!0 = !{!"ModuleMD", !1, !2, !60, !152, !182, !198, !211, !221, !223, !224, !235, !236, !237, !238, !242, !243, !244, !245, !246, !247, !248, !249, !250, !251, !252, !253, !254, !256, !260, !261, !262, !263, !264, !265, !266, !123, !267, !270, !272, !275, !276}
...
!267 = !{!"PrivateMemoryPerFG", !268, !269}
!268 = !{!"PrivateMemoryPerFGMap[0]", void (float addrspace(3)*, float addrspace(1)*, float addrspace(1)*, <8 x i32>, <8 x i32>, i16, i16, i16, i32, i32)* @_ZTSZZ4mainENKUlRT_E_clIN4sycl3_V17handlerEEEDaS0_EUlNS4_7nd_itemILi3EEEE_}
!269 = !{!"PrivateMemoryPerFGValue[0]", i32 0}
!270 = !{!"capabilities", !271}
!271 = !{!"globalVariableDecorationsINTEL", i1 false}
!272 = !{!"m_ShaderResourceViewMcsMask", !273, !274}
!273 = !{!"m_ShaderResourceViewMcsMaskVec[0]", i64 0}
!274 = !{!"m_ShaderResourceViewMcsMaskVec[1]", i64 0}
!275 = !{!"computedDepthMode", i32 0}
!276 = !{!"isHDCFastClearShader", i1 false}
!277 = !{void (float addrspace(3)*, float addrspace(1)*, float addrspace(1)*, <8 x i32>, <8 x i32>, i16, i16, i16, i32, i32)* @_ZTSZZ4mainENKUlRT_E_clIN4sycl3_V17handlerEEEDaS0_EUlNS4_7nd_itemILi3EEEE_, !278}
!278 = !{!279, !280, !290}
!279 = !{!"function_type", i32 0}
!280 = !{!"implicit_arg_desc", !281, !282, !283, !284, !285, !286, !288}
!281 = !{i32 0}
!282 = !{i32 1}
!283 = !{i32 7}
!284 = !{i32 8}
!285 = !{i32 9}
!286 = !{i32 14, !287}
!287 = !{!"explicit_arg_num", i32 1}
!288 = !{i32 14, !289}
!289 = !{!"explicit_arg_num", i32 2}
!290 = !{!"sub_group_size", i32 32}
!291 = !{i32 2, i32 0}
!292 = !{!"clang version 11.1.0"}
